...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        make, created = Product.objects.update_or_create(category=category, addOnes=addOnes, img=validated_data.pop('img'),name=validated_data.pop('name'), price=validated_data.pop('price'))
        return make
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        products = ProductSerializer.create(ProductSerializer(), validated_data=products_data)
